function cmdHelper(switches='--', debug=false) {
...
cmdHelper.process = function(handler, switches='--', debug=false) {
    if (typeof handler !== 'function' || handler === null)
        return null;

    return handler(cmdHelper(switches, debug));
};

exports = module.exports = cmdHelper;
